...
public class CONNL_Reader {
	...
	*/
	...
	public CONNL_Reader(String[] form, String[] lemma, String[] cpostag, String[] postag,
	...
	public CONNL_Reader(String[] lines) {
		length = lines.length;		
	...
	public static ArrayList<CONNL_Reader> getTreebankFromFile(File connlFile, String encoding) throws FileNotFoundException {
		ArrayList<CONNL_Reader> treebank = new ArrayList<CONNL_Reader>();
		Scanner connlScan = new Scanner(connlFile, encoding);
		String[] linesSentence; 
		do {
			linesSentence = CONNL_Reader.getNextConnlLinesSentence(connlScan);
