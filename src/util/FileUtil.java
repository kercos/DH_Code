...
public class FileUtil {
	...
	*/   
	...
	public static File changeExtension(File selectedFile, String ext) {
		return replaceExtension(true, selectedFile, ext);
	}
	
	public static File replaceExtension(boolean addDot, File selectedFile, String ext) {		
		String tail = ext;
		if (addDot)		
			tail = ext.charAt(0)=='.' ? ext : "." + ext;
		String path = selectedFile.getParent();
		String fileName = selectedFile.getName();
		if (fileName.endsWith(tail)) return selectedFile;			
