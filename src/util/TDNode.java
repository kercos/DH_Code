...
public class TDNode implements Serializable, Comparable<TDNode> {
	...
	public String lex, lemma, postag, deprel;
	public int index;
	...
	public static TDNode[] getTreeStructure(String[] wordArray, String[] lemmaArray, 
			String[] postagsArray, String[] deprelArray, int[] indexesArray, 
		...
		for(int i=0; i<sentenceLength; i++) {
			...
			treeStructure[i].lemma = lemmaArray[i];
			treeStructure[i].postag = postagsArray[i];
			treeStructure[i].deprel = deprelArray[i];
		}
		for(int i=0; i<sentenceLength; i++) {
	...
	public static ArrayList<TDNode> getRoots(TDNode[] structure) {
