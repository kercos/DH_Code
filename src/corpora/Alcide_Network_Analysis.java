...
public class Alcide_Network_Analysis {
	...
	*/
	...
	static void processCsvFile(ResultSet rs) throws FileNotFoundException, IOException, SQLException {
		out.println("Processing file: " + rs);
	...
	*/
	...
	public static void processResultSet(ResultSet rs) throws Exception {
		...
		File keywordFile = new File("data/patterns.txt");
		...
		File logFile = new File("data/" + Utility.getDateTime() + "_mode_" + nodeSDcutOff + "_" + arcSDcutOff + ".log");
